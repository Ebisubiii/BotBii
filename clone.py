...
wait = {
    ...
    'timeline':True,
    'autoAdd':True,
    'message':"Thanks For you Akun Official line.me/ti/p/~@enr7503k",
    "lang":"JP",
    "comment":"Creator BOT : line.me/ti/p/~ebisuindo",
    "commentOn":True,
    "commentBlack":{},
    "wblack":False,
    "dblack":False,
...
#-----------------------------------------------
				...
				if msg.from_ in admin:
					ki.sendText(msg.to,"☠HadirTuan☠")
#-----------------------------------------------
            elif "Bii say " in msg.text:
					bctxt = msg.text.replace("Bii say ","")
			...
			for zx in range(0,20):
				...
				if hasil['result']['posts'][zx]['postInfo']['liked'] == False:
					try:    
						...
						cl.comment(hasil['result']['posts'][zx]['userInfo']['mid'],hasil['result']['posts'][zx]['postInfo']['postId']," ✎ Auto Like line.me/ti/p/~@enr7503k")
						kk.like(hasil['result']['posts'][zx]['userInfo']['mid'],hasil['result']['posts'][zx]['postInfo']['postId'],likeType=1002)
						kk.comment(hasil['result']['posts'][zx]['userInfo']['mid'],hasil['result']['posts'][zx]['postInfo']['postId']," ✎ Creator BII")
						print "DiLike"
					except:
							pass
				else:
